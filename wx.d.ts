...
* 批量添加卡券。 
*/ 
function addCard(obj: any): void;

/**
* 调用后，用户可以选择将该表单以“新增联系人”或“添加到已有联系人”的方式，写入手机系统通讯录，完成手机通讯录联系人和联系方式的增加。 
*/ 
function addPhoneContact(obj: any): void;
...
*/ 
function authorize(obj: any): void;
...
*/ 
function canvasToTempFilePath(obj: any): void;

/**
* 截取当前屏幕内容 
*/ 
function captureScreen(obj: any): void;
...
*/ 
function checkSession(obj: any): void;

/**
* 调起用户编辑收货地址原生界面，并在编辑完成后返回用户选择的地址。 
*/ 
function chooseAddress(obj: any): void;

/**
* 调起选择手机通讯录联系人界面，返回用户选择的联系人信息。 
*/ 
function chooseContact(obj: any): void;

/**
* 从本地相册选择图片或使用相机拍照。 
*/ 
function chooseImage(obj: any): void;

/**
* 打开地图选择位置 
*/ 
function chooseLocation(obj: any): void;

/**
* 拍摄视频或从手机相册中选视频，返回视频的临时文件路径。 
*/ 
function chooseVideo(obj: any): void;
...
* 断开与低功耗蓝牙设备的连接 
*/ 
function closeBLEConnection(obj: any): void;

/**
* 关闭蓝牙模块。调用该方法将断开所有已建立的链接并释放系统资源 
*/ 
function closeBluetoothAdapter(obj: any): void;

/**
* 关闭WebSocket连接。 
*/ 
function closeSocket(obj: any): void;
...
* 连接低功耗蓝牙设备 
*/ 
function createBLEConnection(obj: any): void;
...
*/ 
function downloadFile(obj: any): void;

/**
* 蓝牙设备characteristic(特征值)信息 
*/ 
function getBLEDeviceCharacteristics(obj: any): void;

/**
* 获取蓝牙设备所有 service（服务） 
*/ 
function getBLEDeviceServices(obj: any): void;
...
* 获取系统剪贴板内容 
*/ 
function getClipboardData(obj: any): void;

/**
* 根据 uuid 获取处于已连接状态的设备 
*/ 
function getConnectedBluetoothDevices(obj: any): void;

/**
* 获取第三方平台自定义的数据字段。 
*/ 
function getExtConfig(obj: any): void;
...
* 获取文件信息 
*/ 
function getFileInfo(obj: any): void;

/**
* 获取图片信息 
*/ 
function getImageInfo(obj: any): void;

/**
* 获取当前的地理位置、速度。当用户离开小程序后，此接口无法调用；当用户点击“显示在聊天顶部”时，此接口可继续调用。 
*/ 
function getLocation(obj: any): void;

/**
* 获取网络类型。 
*/ 
function getNetworkType(obj: any): void;

/**
* 获取本地文件的文件信息。此接口只能用于获取已保存到本地的文件，若需要获取临时文件信息，请使用 [wx.getFileInfo](./getFileInfo.md) 接口。 
*/ 
function getSavedFileInfo(obj: any): void;

/**
* 获取本地已保存的文件列表 
*/ 
function getSavedFileList(obj: any): void;

/**
* 获取屏幕亮度。 
*/ 
function getScreenBrightness(obj: any): void;

/**
* 获取用户的当前设置 
*/ 
function getSetting(obj: any): void;

/**
* 获取转发详细信息 
*/ 
function getShareInfo(obj: any): void;

/**
* 从本地缓存中异步获取指定 key 对应的内容。 
*/ 
function getStorage(obj: any): void;

/**
* 异步获取当前storage的相关信息 
*/ 
function getStorageInfo(obj: any): void;
...
* 获取系统信息。 
*/ 
function getSystemInfo(obj: any): void;
...
*/ 
function getUserInfo(obj: any): void;

/**
* 获取用户过去三十天微信运动步数，需要先调用 [wx.login](./api-login.md#wxloginobject) 接口。 
*/ 
function getWeRunData(obj: any): void;
...
* 隐藏转发按钮 
*/ 
function hideShareMenu(obj: any): void;
...
* wx.makePhoneCall({ 
*/ 
function makePhoneCall(obj: any): void;

/**
* 关闭当前页面，返回上一页面或多级页面。可通过 [`getCurrentPages()`](../framework/app-service/page.md#getCurrentPages()) 获取当前的页面栈，决定需要返回几层。 
*/ 
function navigateBack(obj: any): void;

/**
* 返回到上一个小程序，只有在当前小程序是被其他小程序打开时可以调用成功 
*/ 
function navigateBackMiniProgram(obj: any): void;

/**
* 保留当前页面，跳转到应用内的某个页面，使用`wx.navigateBack`可以返回到原页面。 
*/ 
function navigateTo(obj: any): void;

/**
* 打开同一公众号下关联的另一个小程序。 
*/ 
function navigateToMiniProgram(obj: any): void;

/**
* 启用低功耗蓝牙设备特征值变化时的 notify 功能。注意：必须设备的特征值支持`notify`才可以成功调用，具体参照 characteristic 的 properties 属性 
*/ 
function notifyBLECharacteristicValueChange(obj: any): void;
...
* 初始化蓝牙适配器 
*/ 
function openBluetoothAdapter(obj: any): void;

/**
* 查看微信卡包中的卡券。 
*/ 
function openCard(obj: any): void;

/**
* 新开页面打开文档，支持格式：doc, xls, ppt, pdf, docx, xlsx, pptx 
*/ 
function openDocument(obj: any): void;

/**
* ​	使用微信内置地图查看位置 
*/ 
function openLocation(obj: any): void;

/**
* 调起客户端小程序设置界面，返回用户设置的操作结果 
*/ 
function openSetting(obj: any): void;

/**
* 将页面滚动到目标位置。 
*/ 
function pageScrollTo(obj: any): void;
...
*/ 
function playBackgroundAudio(obj: any): void;

/**
* 开始播放语音，同时只允许一个语音文件正在播放，如果前一个语音文件还没播放完，将中断前一个语音播放。 
*/ 
function playVoice(obj: any): void;

/**
* 预览图片。 
*/ 
function previewImage(obj: any): void;

/**
* 关闭所有页面，打开到应用内的某个页面。 
*/ 
function reLaunch(obj: any): void;

/**
* 读取低功耗蓝牙设备的特征值的二进制数据值。注意：必须设备的特征值支持`read`才可以成功调用，具体参照 characteristic 的 properties 属性 
*/ 
function readBLECharacteristicValue(obj: any): void;

/**
* 关闭当前页面，跳转到应用内的某个页面。 
*/ 
function redirectTo(obj: any): void;

/**
* 删除本地存储的文件 
*/ 
function removeSavedFile(obj: any): void;

/**
* 从本地缓存中异步移除指定 key 。 
*/ 
function removeStorage(obj: any): void;
...
*/ 
function request(obj: any): void;

/**
* 发起微信支付。 
*/ 
function requestPayment(obj: any): void;

/**
* 保存文件到本地。 
*/ 
function saveFile(obj: any): void;

/**
* 保存图片到系统相册，需要用户授权（scope.writePhotosAlbum），详见 [用户授权](./authorize.md#wxauthorizeobject) 
*/ 
function saveImageToPhotosAlbum(obj: any): void;

/**
* 保存视频到系统相册，需要用户授权（scope.writePhotosAlbum），详见 [用户授权](./authorize.md#wxauthorizeobject) 
*/ 
function saveVideoToPhotosAlbum(obj: any): void;

/**
* 调起客户端扫码界面，扫码成功后返回对应的结果 
*/ 
function scanCode(obj: any): void;

/**
* 控制音乐播放进度。 
*/ 
function seekBackgroundAudio(obj: any): void;

/**
* 通过 WebSocket 连接发送数据，需要先 [wx.connectSocket](#wxconnectsocketobject)，并在 [wx.onSocketOpen](#wxonsocketopencallback) 回调之后才能发送。 
*/ 
function sendSocketMessage(obj: any): void;

/**
* 设置系统剪贴板的内容 
*/ 
function setClipboardData(obj: any): void;

/**
* 设置是否打开调试开关，此开关对正式版也能生效。 
*/ 
function setEnableDebug(obj: any): void;

/**
* 设置是否保持常亮状态。仅在当前小程序生效，离开小程序后设置失效。 
*/ 
function setKeepScreenOn(obj: any): void;

/**
* wx.setNavigationBarColor({ 
*/ 
function setNavigationBarColor(obj: any): void;

/**
* 动态设置当前页面的标题。 
*/ 
function setNavigationBarTitle(obj: any): void;

/**
* 设置屏幕亮度。 
*/ 
function setScreenBrightness(obj: any): void;

/**
* 将数据存储在本地缓存中指定的 key 中，会覆盖掉原来该 key 对应的内容，这是一个异步接口。 
*/ 
function setStorage(obj: any): void;
...
* ​显示操作菜单 
*/ 
function showActionSheet(obj: any): void;

/**
* 显示 loading 提示框, 需主动调用 [wx.hideLoading](#wxhideloading) 才能关闭提示框 
*/ 
function showLoading(obj: any): void;

/**
* ​显示模态弹窗 
*/ 
function showModal(obj: any): void;
...
* 显示当前页面的转发按钮 
*/ 
function showShareMenu(obj: any): void;

/**
* 显示消息提示框 
*/ 
function showToast(obj: any): void;

/**
* 开始监听加速度数据。 
*/ 
function startAccelerometer(obj: any): void;

/**
* 开始搜索附近的`iBeacon`设备 
*/ 
function startBeaconDiscovery(obj: any): void;

/**
* 开始搜寻附近的蓝牙外围设备。注意，该操作比较耗费系统资源，请在搜索并连接到设备后调用 stop 方法停止搜索。 
*/ 
function startBluetoothDevicesDiscovery(obj: any): void;

/**
* 开始监听罗盘数据。 
*/ 
function startCompass(obj: any): void;

/**
* 开始录音。当主动调用`wx.stopRecord`，或者录音超过1分钟时自动结束录音，返回录音文件的临时文件路径。当用户离开小程序时，此接口无法调用。 
*/ 
function startRecord(obj: any): void;

/**
* 停止监听加速度数据。 
*/ 
function stopAccelerometer(obj: any): void;
...
* 停止搜索附近的`iBeacon`设备 
*/ 
function stopBeaconDiscovery(obj: any): void;

/**
* 停止搜寻附近的蓝牙外围设备。请在确保找到需要连接的设备后调用该方法停止搜索。 
*/ 
function stopBluetoothDevicesDiscovery(obj: any): void;

/**
* 停止监听罗盘数据。 
*/ 
function stopCompass(obj: any): void;
...
*/ 
function switchTab(obj: any): void;

/**
* 更新转发属性 
*/ 
function updateShareMenu(obj: any): void;
...
*/ 
function uploadFile(obj: any): void;

/**
* 使手机发生较长时间的振动（400ms） 
*/ 
function vibrateLong(obj: any): void;

/**
* 使手机发生较短时间的振动（15ms） 
*/ 
function vibrateShort(obj: any): void;

/**
* 向低功耗蓝牙设备特征值中写入二进制数据。注意：必须设备的特征值支持`write`才可以成功调用，具体参照 characteristic 的 properties 属性 
*/ 
function writeBLECharacteristicValue(obj: any): void;
